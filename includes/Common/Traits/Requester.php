...
namespace ThemeStarter\Signature\Common\Traits;
			...
			default:
				wp_die(
					...
					/* translators: %s: request function */
						esc_html__( 'Unknown request type: %s.', 'signature' ),
						esc_html( $type )
					),
					esc_html__( 'Classes are not being correctly requested.', 'signature' ),
					__FILE__
				);
		}
	}
