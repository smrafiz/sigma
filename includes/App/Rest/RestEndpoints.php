...
namespace ThemeStarter\Signature\App\Rest;
...
class RestEndpoints extends Base {
	...
	public function permission() {
		...
		if ( ! $hasPermission ) {
			return new WP_Error(
				...
				esc_html__( 'Sorry, you are not allowed to do that!', 'signature' ),
	...
	public function demoCallback() {
		...
		return $this->sendResponse( $demoConfig, esc_html__( 'Data is ready to fetch', 'signature' ) );
	}
}
