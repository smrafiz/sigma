...
final class Requirements extends Base {
	...
	public function specifications() {
		return apply_filters(
			'sd/signature/theme_requirements',
			[
	...
	public function versionCompare() {
		return [
			...
			[
				'current' => phpversion(),
				'compare' => $this->theme->requiredPhp(),
				'title'   => esc_html__( 'Invalid PHP version', 'signature' ),
				'message' => sprintf(
					/* translators: 1. Required php version, 2. Current php version */
					esc_html__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'signature' ),
			...
			[
				...
				'compare' => $this->theme->requiredWp(),
				'title'   => esc_html__( 'Invalid WordPress version', 'signature' ),
				'message' => sprintf(
